...
type Citizen struct {
	...
	VerifiedVia  string         `json:"verified_via"`  // "moltbook", "bluesky"
	VerifiedUser string         `json:"verified_user"` // username on that platform
...
// PendingVerification tracks a citizen-in-progress waiting for social verification.
type PendingVerification struct {
	Code      string    `json:"code"`
	Provider  string    `json:"provider"` // "moltbook", "bluesky"
